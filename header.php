	...
	<header class="l-padding-top-2xs l-padding-bottom-2xs l-padding-top-xs-l l-padding-bottom-xs-l" data-theme="<?php echo esc_attr( $theme ); ?>">
		...
		<nav class="c-nav l-container t-link-current" aria-label="Main">
			...
			<div class="l-flex l-justify-between l-align-center">
				<?php /* phpcs:ignore */ ?>
				<?php echo $logo; ?>
				<ul class="c-nav__list l-flex l-flex-wrap l-align-center l-gap-margin-s l-gap-margin-sm-l t-list-style-none t-foreground-dark t-link-current" role="list">
					<?php /* phpcs:ignore */ ?>
					<?php echo $main_nav; ?>
				</ul>
				<button class="c-nav__button l-relative l-z-index-1" type="button" aria-haspopup="true" aria-controls="<?php echo esc_attr( $main_nav_overflow_id ); ?>">
					<div class="c-nav-icon l-relative l-margin-auto e-transition" data-num="4">
						<div class="c-nav-icon__top e-transition bg-foreground-dark"></div>
						<div class="c-nav-icon__middle e-transition bg-foreground-dark"></div>
						<div class="c-nav-icon__bottom e-transition bg-foreground-dark"></div>
					</div>
					<div class="c-nav__label t-h6 l-padding-top-5xs e-transition">Menu</div>
				</button>
				<div class="c-nav-overflow l-fixed l-right-0 l-bottom-0 l-height-100-vh bg-primary-light e-transition l-width-4-5" role="dialog" aria-modal="true" aria-label="Main navigation" id="<?php echo esc_attr( $main_nav_overflow_id ); ?>">
