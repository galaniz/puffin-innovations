			...
			if ( $media_video ) {
				...
				$button = (
					'<div class="l-absolute l-top-0 l-left-0 l-right-0 l-bottom-0 l-margin-auto l-flex l-align-center l-justify-center l-z-index-1 l-width-1-5 l-max-width-2xl">' .
						"<button type='button' class='l-width-100-pc l-margin-auto l-relative l-aspect-ratio-100 l-flex l-align-center l-justify-center b-radius-100-pc b-all b-light-60 t-background-light bg-background-light-20 e-transition e-scale js-modal-trigger' aria-haspopup='true' aria-controls='$dialog_id'>" .
				...
				if ( $content || $video_label ) {
					$dialog_text = (
						'<div class="o-modal__scroll l-flex-shrink-0 l-overflow-y-auto l-overscroll-none l-overflow-x-hidden l-width-1-1 l-width-1-3-l">' .
